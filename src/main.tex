...
% Recommendations for thesis printing:
...
\begin{document}
  \frontmatter \includepdf{../figures/PhD_first_page.pdf}
  ...
  \section*{Acknowledgements} \input{acknowledgement.tex}
  ...
  \chapter{Fluctuations in magnetized plasmas} \input{first_chapter.tex}

  \chapter{Reduced fluid models for SOL plasmas} \input{second_chapter.tex}

  \chapter{Stochastic modeling} \input{third_chapter.tex}

  \chapter{Summary of Papers}\label{ch:sum-paper} \input{summary_of_papers.tex}

  \chapter{Conclusion and future work}\label{ch:conclusion} \input{conclusion.tex}
  ...
  % \addtocontents{toc}{\protect\newpage}  % Not necessary?
  \addtocontents{toc}

  \chapter{Paper I: \\ Intermittent fluctuations due to Lorentzian pulses in turbulent
    thermal convection}

  \chaptermark{Paper I} G. Decristoforo, A. Theodorsen and O. E. Garcia,\\ Physics of
  ...
  \chapter{Paper II: \\ Dirac comb and exponential frequency spectra in chaotic
    dynamics} \chaptermark{Paper II} A. Theodorsen, G. Decristoforo and O. E. Garcia,\\
  ...
  \chapter{Paper III: \\ Numerical turbulence simulations of intermittent fluctuations
    in the scrape-off layer of magnetized plasmas} \chaptermark{Paper III} G.
  ...
  \chaptermark{Paper IV} G. Decristoforo, F. Militello, T. Nicholas, J. Omotani, C.
  ...
  \includepdf[pages=-]{../papers/Blob_interactions.pdf} %\end{comment}
\end{document}
